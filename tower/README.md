...
이 폴더는 `pooha0129/pooha0129.github.io`의 GitHub Pages에서 이미지 파일을 직접 제공하기 위한 공간입니다. 기존 `today-promise` 플래너는 별도 저장소에 그대로 둡니다.
...
공개 기본 주소: `https://pooha0129.github.io/tower/`

예: `https://pooha0129.github.io/tower/MAP/1.webp`
...
현재 `MAP/1.webp`는 공개 URL에서 직접 열리는 것을 확인한 연결 테스트용 그림입니다. 실제 세계관 이미지가 준비되면 별도 이름으로 추가하거나 이 파일을 교체할 수 있습니다.
...
형식: ![이미지 설명](https://pooha0129.github.io/tower/종류/파일명.webp)
중괄호나 역슬래시를 출력하지 않는다.
...
테스트 출력: `![연결 테스트](https://pooha0129.github.io/tower/MAP/1.webp)`
